...
//
/////////////////////////////////////////////////////////
const getViewableItems = (doc, roles = ['3d', '2d']) => {
...
//
/////////////////////////////////////////////////////////
const createButton= (id, className, tooltip, handler) => {
...
//
/////////////////////////////////////////////////////////
const createControlGroup = (viewer, ctrlGroupName) => {
...
const getFragIds = (model, dbIds) => {
  ...
  return new Promise(async(resolve, reject) => {
    ...
    try {
      ...
      const leafIds = it
        ? await getLeafNodes(model, dbIdArray)
        : dbIdArray
...
//
/////////////////////////////////////////////////////////
const getLeafFragIds = (model, leafId) => {
...
//
/////////////////////////////////////////////////////////
const getWorldBoundingBox = (model, dbId) => {
...
const getWorldBoundingBoxSync = (model, dbId) => {
...
//
/////////////////////////////////////////////////////////
const getProperties = (model, dbId, requestedProps = null) => {
...
//
/////////////////////////////////////////////////////////
const getProperty = (model, dbId, displayName, defaultValue) => {
...
//
/////////////////////////////////////////////////////////
const getNodeData = (viewer, dbId, model) => {
...
//
/////////////////////////////////////////////////////////
const getPropertyList = (viewer, dbIds, model = null) => {
  ...
  return new Promise(async(resolve, reject) => {
    ...
    try {
      ...
      var propertyTasks = dbIds.map((dbId) => {
        ...
        return getProperties(model, dbId)
      })
...
//
/////////////////////////////////////////////////////////
const getBulkPropertiesAsync = (model, dbIds, propFilter) => {
...
//
/////////////////////////////////////////////////////////
const mapComponentsByProp = 
  (model, propFilter, components, defaultProp) => {

  return new Promise(async (resolve, reject) => {

    try {

      const results = await getBulkPropertiesAsync(
...
//
/////////////////////////////////////////////////////////////
const runTaskOnDataTree = (root, taskFunc) => {
...
//
/////////////////////////////////////////////////////////
const drawBox = (viewer, min, max, material, overlayId) => {
...
//
/////////////////////////////////////////////////////////
const setMaterial = async (model, dbId, material) => {
...
//
/////////////////////////////////////////////////////////
const buildModelTree = (model, createNodeFunc = null) => {
...
//
/////////////////////////////////////////////////////////
const executeTaskOnModelTree = (model, task) => {
...
//
/////////////////////////////////////////////////////////
const hide = (viewer, dbIds = [], model = null) => {
...
//
/////////////////////////////////////////////////////////
const show = (viewer, dbIds = [], model = null) => {
...
const isolateFull = 
  ...
  try {
    ...
    const targetLeafIds = await getLeafNodes(
      model, targetIds)
...
//
///////////////////////////////////////////////////////////////////
const rotateFragments = 
  (viewer, fragIds, axis, angle, center, model = null) => {
...
//
/////////////////////////////////////////////////////////
const getComponentsByParentName = (name, model) => {
...
//
/////////////////////////////////////////////////////////
const selectiveExplode =
  (viewer, scale, excludedFragIds, model = null) => {
...
//
/////////////////////////////////////////////////////////
const transformFragProxy =
  (viewer, model, fragId, transform) => {

  const fragProxy =
    viewer.impl.getFragmentProxy(
      model, fragId)
...
//
/////////////////////////////////////////////////////////
const transformModel = (viewer, model, transform) => {
...
export {
  ...
  createControlGroup,
  drawBox,
  executeTaskOnModelTree,
  getBulkPropertiesAsync,
  getComponentsByParentName,
  getFragIds,
  getLeafFragIds,
  getLeafNodes,
  getNodeData,
