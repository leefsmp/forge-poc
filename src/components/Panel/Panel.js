...
class Panel extends EventsEmitter {
  ...
  /////////////////////////////////////////////////////////
  static defaultProps = {
    displayMode: 'expand', //[expand, fadeIn]
    maxHeight: Infinity,
    maxWidth: Infinity,
    resizeable: true,
    draggable: true,
  ...
  constructor (props) {
    ...
    this.id = this.props.id || this.guid()
    ...
    const height = (this.props.displayMode !== 'expand')
      ? (this.props.height || 300) 
      : 35  

    this.react.setState({

      classNames: [this.props.displayMode],
      ...
      switch (this.props.displayMode) {
        case 'expand':
          this.runAnimation(
            35, this.props.height, 1.0)
          break
        case 'fadeIn':
          this.react.setState({
            classNames: ['fadeIn', 'active']
          })
          break
      }
    })
